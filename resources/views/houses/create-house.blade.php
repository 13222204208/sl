...
<body>
   ...
   /**                     var renderTable=  treeTable.render({
        ...
        treeTable.render({
            ...
            treeLinkage: false,	
            reqData: function(data, callback) {console.log(data);
                //var pid = data?data.id:id;
                if(data){
                    $.get('gain/house/num/'+data.id, function (res) {
                        callback(res.data);
                    });
                }else{
                    $.get('gain/loupan/'+id, function (res) {console.log(res)
                        callback(res.data);
                    });
                }
